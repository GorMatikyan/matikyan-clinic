          ...
          <div className="relative">
            ...
            <div className="relative rounded-[2rem] bg-[#17223c]/55 p-4 shadow-[0_28px_78px_rgba(0,0,0,0.24)] ring-1 ring-white/10 sm:p-5">
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <img src={siteImages.heroSlides[3].full} srcSet={`${siteImages.heroSlides[3].mobile} 960w, ${siteImages.heroSlides[3].full} ${siteImages.heroSlides[3].fullWidth}w`} sizes="(min-width: 640px) 25vw, 50vw" alt={t("about.images.clinicAlt")} className="h-40 w-full rounded-[1.2rem] object-cover object-center shadow-[0_14px_34px_rgba(0,0,0,0.2)] sm:h-52 lg:h-44 xl:h-52" loading="lazy" />
                <img src={siteImages.aboutImages.equipment.full} srcSet={`${siteImages.aboutImages.equipment.mobile} 960w, ${siteImages.aboutImages.equipment.full} ${siteImages.aboutImages.equipment.fullWidth}w`} sizes="(min-width: 640px) 25vw, 50vw" alt={t("about.images.equipmentAlt")} className="h-40 w-full rounded-[1.2rem] object-cover object-center shadow-[0_14px_34px_rgba(0,0,0,0.2)] sm:h-52 lg:h-44 xl:h-52" loading="lazy" />
                <img src={siteImages.heroSlides[2].full} srcSet={`${siteImages.heroSlides[2].mobile} 960w, ${siteImages.heroSlides[2].full} ${siteImages.heroSlides[2].fullWidth}w`} sizes="(min-width: 640px) 25vw, 50vw" alt={t("about.images.consultationAlt")} className="h-40 w-full rounded-[1.2rem] object-cover object-center shadow-[0_14px_34px_rgba(0,0,0,0.2)] sm:h-52 lg:h-44 xl:h-52" loading="lazy" />
                <img src={siteImages.heroSlides[1].full} srcSet={`${siteImages.heroSlides[1].mobile} 960w, ${siteImages.heroSlides[1].full} ${siteImages.heroSlides[1].fullWidth}w`} sizes="(min-width: 640px) 25vw, 50vw" alt={t("about.images.interiorAlt")} className="h-40 w-full rounded-[1.2rem] object-cover object-center shadow-[0_14px_34px_rgba(0,0,0,0.2)] sm:h-52 lg:h-44 xl:h-52" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#F7FAFC] py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-[0.95fr_1.05fr] gap-10 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <img src={siteImages.aboutImages.consultation.full} srcSet={`${siteImages.aboutImages.consultation.mobile} 960w, ${siteImages.aboutImages.consultation.full} ${siteImages.aboutImages.consultation.fullWidth}w`} sizes="(min-width: 1024px) 50vw, 100vw" alt={t("about.images.consultationAlt")} className="relative h-[420px] w-full rounded-[1.75rem] border border-white object-cover shadow-[0_24px_70px_rgba(15,25,50,0.14)]" loading="lazy" />
          </div>
        </div>
      </section>
