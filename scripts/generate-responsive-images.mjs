// One-off generator, not part of the build pipeline: source hero images are pre-committed
// static assets that rarely change, so a smaller "-mobile" WebP variant is generated once and
// committed alongside the original, rather than resized on every build.
//
...
for (const file of sources) {
  ...
  const outputPath = path.join(HERO_DIR, file.replace(/\.webp$/, "-mobile.webp"));
